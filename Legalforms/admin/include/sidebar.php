...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="insert-Blogs.php"><i class="menu-icon icon-paste"></i>Insert Blog </a></li>
                                ...
                                <li><a href="reclawyers.php"><i class="menu-icon icon-paste"></i>Recomanded Lawyers </a></li>
                                <li><a href="manage-rec-lawyer.php"><i class="menu-icon icon-table"></i>Manage Recomanded Lawyers </a></li>
