...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/slid1.png" alt="" class="img-responsive">
			</div>
			<div class="container-fluid">
				<div class="caption vertical-top text-left" style="color: #fff;">
...
while($row=mysqli_fetch_array($sql))
{
    ?>
					...
					<div class="excerpt hidden-sm hidden-md" style="color: #fff;">
