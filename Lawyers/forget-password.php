...
$query=mysqli_query($con,"SELECT * FROM lawyer WHERE email='$email' and contactno='$contactno'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forget-password.php";
mysqli_query($con,"update lawyer set password='$password' WHERE email='$email' and contactno='$contactno' ");
...
<html lang="en">
	<head>
	    ...
	    <title>Kachari | Forgot Password</title>
		...
		<!--<link rel="stylesheet" href="../Legalforms/assets/css/owl.theme.css">-->
		<link href="../Legalforms/assets/css/lightbox.css" rel="stylesheet">
...
<div class="col-md-6 col-sm-6 sign-in">
	...
	<form class="register-form outer-top-xs" name="register" method="post" autocomplete="off">
