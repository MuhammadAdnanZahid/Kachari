 ...
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <!-- .......................................Search End............................... -->
            ...
            <p class="breadcrumbs">
                ...
                <span>Property Law <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="thumbnail">
            <a class="card-category">
                <h1 class="mb-4"> <span class="flaticon-house" style="margin-right: 9px;"></span>Property Law</h1>
            </a>
        </div>
    </div>
                   ...
                   <p class="text-justify">Real estate law, or property law, generally refers to the laws controlling the ownership or use of land in the United States. Real estate law is a branch of civil law that covers the right to possess, use, and enjoy land and the permanent man-made additions attached to it. Real estate law directly or indirectly impacts most of us on a daily basis, affecting homeowners, renters, landlords, home buyers, and home sellers.</p>

 <p class="text-justify">In the United States, every state has exclusive jurisdiction over the land within its borders. Each state has the power to determine the form and effect of a transfer of real property in its jurisdiction. As a result, state law requirements vary significantly from state to state.
                   </p>

                   <h2>Real Property & Personal Property</h2>
                   ...
                   <h2>Real Estate Sales & Purchases</h2>

                   <p class="text-justify">

        When a piece of property is sold, real estate brokers or agents are often hired by the seller to obtain a buyer for a property. Real estate brokers, agents, and salespeople are licensed and regulated by local state laws.</p>

        <p class="text-justify">A real estate agreement between a buyer and seller of real estate is governed by general principles of contract law and individual state laws. The sale or transfer of real property is almost always required to be in writing. It is often required in real estate contracts that the title to the property sold be "marketable." An attorney or a title insurance company is frequently employed to investigate a title's legal marketability.</p>
         <p class="text-justify">In order to pass the title, a deed with a proper description of the land must be executed and delivered. Some states require that the deed be officially recorded to establish ownership of the property and/or provide notice of its transfer to subsequent purchasers.</p>

                <h2>Landlord / Tenant and Land Use Laws</h2>
           <p class="text-justify">
        In addition to the purchase or sale of lands, states typically regulate the renting or leasing of property for residential or commercial purposes. Such laws cover a range of practices, such as how security deposits are handled, evictions, and more.</p>
<p class="text-justify">State and local laws may also have a substantial effect on how owners use their property. Zoning and environmental laws affect development and construction projects. Further, community or homeowner association rules affect the use of property in many modern residential communities. FindLaw's Real Estate Center has in-depth information on buying a home, refinancing a home, selling a home, avoiding foreclosure, and more. You can find out what you need to know about renter's rights, finding the right mortgage, home equity loans, foreclosure, and a host of other real estate issues.</p>
   ...
   <div class="law-category">
        ...
        <h2 >
            <a href="files/property.pdf" target="_dpdf">Download Complete Property law Ordinence</a>
        </h2>
    </div>
